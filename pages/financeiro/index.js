...
import styles from '../../components/financeiro/financeiro.module.css'; // <- Corrigido
import DatePickerRange from '../../components/DatePickerRange'; // <- Corrigido
// 1. CAMINHOS CORRIGIDOS
import KpiCard from '../../components/financeiro/components/KpiCard'; // <- Corrigido
import OrdersTable from '../../components/financeiro/components/OrdersTable'; // <- Corrigido
import PaymentBreakdown from '../../components/financeiro/components/PaymentBreakdown'; // <- Corrigido
import ProductsSoldTable from '../../components/financeiro/components/ProductsSoldTable'; // <- Corrigido
// ---
